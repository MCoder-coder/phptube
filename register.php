...
if( isset($_POST['email']) && isset($_POST['password']) && isset($_POST['repite_password']) && isset($_POST['de_acuerdo']) ) {
  ...
  if ($_POST['password']=="") {
    $msg.= "Debe ingresar un password<br>";
  }
  if ($_POST['repite_password']=="") {
    $msg.= "Debe repetir clave<br>";
  }
  ...
  //solo si no hay usuarios con el mismo mail
  if ($cantidad == 0){
...
<body class="hold-transition register-page">
  <div class="register-box">
    <div class="register-logo">
      <img style="width:200px;" src="img/phptube2.png" alt="">
    </div>
    ...
    <div class="register-box-body">
      ...
      <form action="register.php" method="post">
        ...
        <div class="form-group has-feedback">
          <input name="password" type="password" class="form-control" placeholder="Constraseña">
          <span class="glyphicon glyphicon-lock form-control-feedback"></span>
        </div>
        <div class="form-group has-feedback">
          <input name="repite_password" type="password" class="form-control" placeholder="Repite Contraseña">
        ...
        <div class="row">
          <div class="col-xs-8">
            <div class="checkbox icheck">
              <label>
                <input name="de_acuerdo" value="tildado" type="checkbox" required><a href="#"> Condiciones del Servicio</a>
              </label>
            </div>
          </div>
          <!-- /.col -->
