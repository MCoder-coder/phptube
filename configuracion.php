    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="principal.php" class="logo">
                ...
                <img style="width:70px" src="img/phptube2.png" alt="">
            </a>
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    ...
                    <div class="pull-left info">
                        ...
                        <p><?php echo $_SESSION['usuarios_ultimo_login'] ?></p>
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="">
                        <a href="logut.php">
                            <i class="fa  fa-arrow-circle-o-right"></i> <span>Salir</span>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2019<a href="https://phptube.com">Mr soft</a>.</strong> All rights
            reserved.
        </footer>
